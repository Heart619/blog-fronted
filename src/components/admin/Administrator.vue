<template>
  <div>
    ...
    <el-dialog style="z-index: 20000" title="上传头像" :visible.sync="dialogVisible">
      ...
      <el-dialog class="dialog" title="修改密码" :visible.sync="updatePwddialogVisible" @close="closeChangePwd" width="400px" center>
        <el-form ref="FormRef" :model="Form" :rules="FormRules" class="form" label-width="80px" label-position="left">
          <!--        密码-->
          <el-form-item label="新密码" prop="password">
            <el-input type="password" v-model="Form.newPwd"></el-input>
          </el-form-item>
          <el-form-item label="确认密码" prop="quren">
            <el-input type="password" v-model="Form.queren"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    setNewPwd() {
      if (this.Form.newPwd !== this.Form.queren) {
