        ...
        tooltip: {
          ...
          formatter: function (params) {
            ...
            for (const lt of params.data.users){
              html+=`<div style="display: flex;align-items: center"><img style="width: 18px;border-radius: 50%" src="${p}${lt.avatar}"/><span style="font-size: x-small;margin-left: 5px">${lt.nickname}</span></div>`
            }
            return html
          }
        },
